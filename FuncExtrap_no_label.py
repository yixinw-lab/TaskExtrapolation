...
def plot_F2_comparison(out_png: str, key: str, f2_func: Callable, X_test: np.ndarray, Y_true: np.ndarray, predictions: Dict[str, np.ndarray], title_suffix: str):
    ...
    for i, (model_name, y_pred) in enumerate(predictions.items()):
        ...
        # COLOR LOGIC
        # Transductive models (RTE, GT Transductive) -> Blue
        # Inductive models (GT Inductive, T2V Inductive) -> Red
        # Note: Sparse Baseline is excluded via filter in run_comparison
